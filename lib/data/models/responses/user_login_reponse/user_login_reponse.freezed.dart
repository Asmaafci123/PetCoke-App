...
class _$_UserLoginResponse implements _UserLoginResponse {
  const _$_UserLoginResponse(
      {required this.flag, required this.message, required this.data});
  ...
  @override
  String toString() {
    return 'UserLoginResponse(flag: $flag, message: $message, data: $data)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, flag, message, data);
